...
export default function CitasPage() {
  ...
  // ── CITAS TEMPORALMENTE DESHABILITADAS ──
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-mint-light px-4 py-16">
      <div className="max-w-lg w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-navy mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
          {lang === "en" ? "Online Booking Temporarily Unavailable" : "Reservas en Línea Temporalmente No Disponibles"}
        </h1>
        <p className="text-gray-600 mb-6 leading-relaxed">
          {lang === "en"
            ? "Our online booking system is currently undergoing maintenance. Please contact us directly to schedule your appointment."
            : "Nuestro sistema de citas en línea está en mantenimiento. Contáctanos directamente para agendar tu cita."}
        </p>
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-mint text-left space-y-4 mb-8">
          <a href="tel:5026547076" className="flex items-center gap-3 text-navy hover:text-gold transition-colors font-semibold">
          ...
          <a href="tel:5026441312" className="flex items-center gap-3 text-navy hover:text-gold transition-colors font-semibold">
            <svg className="w-5 h-5 text-gold shrink-0" fill="currentColor" viewBox="0 0 24 24">
              <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24 11.47 11.47 0 003.58.57 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.47 11.47 0 00.57 3.58 1 1 0 01-.25 1.02l-2.2 2.19z"/>
            </svg>
            (502) 644-1312
          ...
          <div className="flex items-center gap-3 text-gray-500 text-sm">
            ...
            {lang === "en" ? "Mon–Fri 10am–6pm · Sat 10am–3:30pm" : "Lun–Vie 10am–6pm · Sáb 10am–3:30pm"}
          </div>
        </div>
        <a href="/" className="btn-gold inline-block px-8 py-3">
